...
import * as styled from './GeoLocationControl.styled';
...
function GeoLocationControl(props: GeoLocationControlProps) {
  return (
    <styled.Container
      onClick={props.askPermissionForGeoLocation}
    >
      <svg viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg' fill='%23333'>
        <path

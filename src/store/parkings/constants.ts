...
export const CREATE_PARKING_ATTEMPT = 'Parkings Page/CREATE_PARKING_ATTEMPT';
export const CREATE_PARKING_SUCCESS = 'Parkings Page/CREATE_PARKING_SUCCESS';
export const CREATE_PARKING_ERROR = 'Parkings Page/CREATE_PARKING_ERROR';
